...
describe('clean', () => {
  it('should remove underscore characters', () => {
    const value = clean('Proportion_of_local_governments_implementing_local_disaster_risk_reduction_strategies')
  ...
  it('should remove underscores, extension and apply start/title case', () => {
    const value = clean('Biotic_genetic_resources_for_food_and_agriculture_secured_in_conservation_facilities.tif')
