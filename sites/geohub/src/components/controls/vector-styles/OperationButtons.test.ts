...
describe('Operation Buttons component', () => {
  ...
  it('should emit a click event when clicked', async () => {
    ...
    expect(component.component.$$.ctx[component.component.$$.props.currentSelectedOperation]).toEqual(
      VectorFilterOperators[component.component.$$.props.currentSelectedOperation].value,
    )
  })
})
