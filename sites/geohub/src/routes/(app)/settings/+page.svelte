<script lang="ts">
	...
	// let activeSettingTab = activeTab.label;
	...
	<section class="section pt-0">
		...
		<div hidden={activeTab !== tabs[1].id}>
			...
			<FieldControl title="Defaut tag search operator" showHelpPopup={false} marginBottom="2rem">
				<div slot="help">
					...
					range of results by matching at least a tag selected.
				</div>
				<div slot="control">
					<div class="select is-fullwidth">
						<select
		...
		<div hidden={activeTab !== tabs[2].id}>
			...
			<FieldControl title="Icon Overlap Priority" showHelpPopup={false} marginBottom="2rem">
				<div slot="help">
					...
					will be visible even if it collides with any other previously drawn symbol. When
			...
			>
				<div slot="help">
					...
					<p>
						<b>Bili-near</b> filtering interpolates pixel values using the weighted average of the four
						closest original source pixels creating a smooth but blurry look when overscaled
					</p>
					<p>
						<b>Nearest neighbour</b> filtering interpolates pixel values using the weighted average of
						the four closest original source pixels creating a smooth but blurry look when overscaled
					</p>
				</div>
				<div slot="control">
					<div class="select is-fullwidth">
						<select name="RasterResamplingMethod" bind:value={userSettings.RasterResamplingMethod}>
		...
		<div class="buttons">
			<button
				formaction="?/save"
				type="submit"
				class="button is-link is-uppercase has-text-weight-bold {isSubmitting ? 'is-loading' : ''}"
			>
				Apply
			</button>
			<button
