...
import {
	...
	tagInGeohub,
	styleInGeohub,
	styleFavouriteInGeohub,
	datasetFavouriteInGeohub,
	storymapInGeohub,
	storymapChaptersInGeohub,
	storymapChapterInGeohub,
	storymapFavouriteInGeohub,
	datasetPermissionInGeohub,
	productInGeohub,
	stacCollectionProductInGeohub,
	stylePermissionInGeohub,
	storymapPermissionInGeohub,
...
export const storymapFavouriteInGeohubRelations = relations(
	storymapFavouriteInGeohub,
	({ one }) => ({
		storymapInGeohub: one(storymapInGeohub, {
...
export const datasetPermissionInGeohubRelations = relations(
	datasetPermissionInGeohub,
	({ one }) => ({
		datasetInGeohub: one(datasetInGeohub, {
...
export const stacCollectionProductInGeohubRelations = relations(
	stacCollectionProductInGeohub,
	({ one }) => ({
...
export const storymapPermissionInGeohubRelations = relations(
	storymapPermissionInGeohub,
	({ one }) => ({
		storymapInGeohub: one(storymapInGeohub, {
...
export const datasetDefaultstyleInGeohubRelations = relations(
	datasetDefaultstyleInGeohub,
	({ one }) => ({
		datasetInGeohub: one(datasetInGeohub, {
