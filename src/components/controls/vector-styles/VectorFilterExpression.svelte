<script lang="ts">
  ...
  const handleApplyExpression = () => {
    ...
    // }
    $map.setFilter(layerId, ['get', simpleExpression.property])
  }
</script>
...
<div class="expression">
  ...
  <div class="columns">
    ...
    <!--      </div>-->
    <!--    </div>-->
    <div class="column" style="display: flex; align-items: center; justify-content: right">
