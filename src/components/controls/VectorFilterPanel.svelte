  ...
  <div class="filter-content">
    <div class="static-content-filter">
      <div class="select is-small">
        <select>
          <option>every filter Matches</option>
          <option>all filter matches</option>
          <option>no filter matches</option>
        </select>
      </div>
      <button class="button primary-button is-small">Apply</button>
    ...
    {#each expressionsArray as expression, index}
      <div class="dynamic-content-filter">
        ...
        <input style="width: 50%" class="input is-small" type="text" placeholder="Value" />
      </div>
    {/each}
