 ...
 */
export class MaplibreCgazAdminControl implements IControl {
	private controlContainer: HTMLElement | undefined;
	private locationContainer: HTMLDivElement | undefined;
	private map?: MaplibreMap;
	private hoveredStateId: string | number | undefined;
