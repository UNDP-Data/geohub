<script lang="ts" module>
	...
	const { Story } = defineMeta({
		title: 'Components/Maplibre/Symbol/IconColor',
	...
	const title = 'Icon Color Control';

	const source: VectorSourceSpecification = {
		type: 'vector',
		url: 'https://geohub.data.undp.org/api/vector/pgtileserv/tile.json?table=rwanda.water_facilities&type=table'
	};

	const layer: SymbolLayerSpecification = {
		id: '9cd1c067-5378-43ce-a9f6-2a4af2681999',
		type: 'symbol',
		source: '97daa546904a2694a70e3bdef8fa0dce',
		'source-layer': 'rwanda.water_facilities',
		minzoom: 0,
		layout: {
			'icon-image': 'circle',
			'icon-size': 1,
		...
		paint: {
			'icon-color': 'rgb(89 236 231)',
			'icon-opacity': 1
		}
	};

	const metadata: VectorTileMetadata = {
		name: 'rwanda.water_facilities',
		version: '1.3.0',
		type: 'overlay',
		attribution:
